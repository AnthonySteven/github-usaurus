...
![Screenshot showing Docusaurus project creation in PowerShell](./images/create-docusaurus-site.png)

## Create a new repo in GitHub to host the site

![Screenshot showing settings for new repo in GitHub](./images/create-github-repo.png)

![Screenshot showing Docusaurus repo in GitHub](./images/git-repository-docusaurus.png)
